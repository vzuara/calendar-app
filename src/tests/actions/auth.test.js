...
describe("Pruebas en las acciones Auth", () => {
  ...
  test("startLogin incorrecto", async () => {
    await store.dispatch(startLogin("email@email.com", "123456789"));
    ...
    await store.dispatch(startLogin("email@email2.com", "123456"));
  ...
  test("startRegister correcto", async () => {
    ...
    await store.dispatch(startRegister("email@test.com", "123456", "test"));
    const actions = store.getActions();
    expect(actions[0]).toEqual({
      type: types.authLogin,
      payload: {
